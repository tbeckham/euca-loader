...
script_url = template.add_parameter(Parameter(
    ...
    Type="String",
    Default="https://gist.githubusercontent.com/tbeckham/03710a014a09a718d541/raw/locustfile.py"
))
...
apt-get install -y python-setuptools python-dev git python-pip gcc unzip ntp apache2 libffi-dev libssl-dev build-essential
